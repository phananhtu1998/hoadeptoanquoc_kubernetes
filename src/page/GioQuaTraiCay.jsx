...
let sortedData = lstdatahoa.filter(item => item.Category === "gio-qua-trai-cay");

const GioQuaTraiCay = ({ setCartItems }) => {
    useEffect(() => {
        document.title = "Giỏ Quà Trái Cây";
        window.scrollTo({
            top: 760,
            left: 0,
        ...
        <div className={style.customstyles}>
            <Container>
                <h1 className={style.h1customtext}>
                    <span className={style.spantextcenter}>Giỏ quà trái cây</span>
                </h1>
