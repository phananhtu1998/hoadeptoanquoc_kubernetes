...
let sortedData = lstdatahoa.filter(item => item.Category === "hoa-chuc-mung" || item.Category === "gio-hoa");

const HoaChucMung = ({ setCartItems }) => {
    useEffect(() => {
        document.title = "Hoa Chúc Mừng";
        window.scrollTo({
            top: 760,
            left: 0,
        ...
        <div className={style.customstyles}>
            <Container>
                <h1 className={style.h1customtext}>
                    <span className={style.spantextcenter}>Hoa chúc mừng</span>
                </h1>
