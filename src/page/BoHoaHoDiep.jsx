...
let sortedData = lstdatahoa.filter(item => item.Category === "bo-hoa-lan-ho-diep");
        ...
        <div className={style.customstyles}>
            <Container>
                <h1 className={style.h1customtext}>
                    <span className={style.spantextcenter}>Bó hoa lan hồ điệp</span>
                </h1>
