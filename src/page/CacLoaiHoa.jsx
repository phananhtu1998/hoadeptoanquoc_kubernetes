...
let sortedData = lstdatahoa.filter(item => item.Category === "cacloaihoa");

const CacLoaiHoa = ({ setCartItems }) => {
    useEffect(() => {
        document.title = "Các Loài Hoa";
        window.scrollTo({
            top: 760,
            left: 0,
        ...
        <div className={style.customstyles}>
            <Container>
                <h1 className={style.h1customtext}>
                    <span className={style.spantextcenter}>Các loài hoa</span>
                </h1>
