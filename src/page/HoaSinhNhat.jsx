...
let sortedData = lstDataHoa.filter(item => item.Category === "bo-hoa" || item.Category === "gio-hoa");

const HoaSinhNhat = ({ setCartItems }) => {
    useEffect(() => {
        document.title = "Hoa Sinh Nhật";
        window.scrollTo({
            top: 760,
            left: 0,
        ...
        <div className={style.customstyles}>
            <Container>
                <h1 className={style.h1customtext}>
                    <span className={style.spantextcenter}>Hoa sinh nhật</span>
                </h1>
