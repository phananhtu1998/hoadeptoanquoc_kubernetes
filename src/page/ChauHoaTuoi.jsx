...
let sortedData = lstDataHoa.filter(item => item.Category === "chau-hoa-tuoi");
const ChauHoaTuoi = ({ setCartItems }) => {
    useEffect(() => {
        document.title = "Chậu Hoa Tươi";
        window.scrollTo({
            top: 760,
            left: 0,
        ...
        <div className={style.customstyles}>
            <Container>
                <h1 className={style.h1customtext}>
                    <span className={style.spantextcenter}>Chậu hoa tươi</span>
                </h1>
