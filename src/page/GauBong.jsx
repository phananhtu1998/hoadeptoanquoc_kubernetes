...
let sortedData = lstBoHoa.filter(item => item.Category === "gau-bong");
const GauBong = ({ setCartItems }) => {
    useEffect(() => {
        document.title = "Gấu Bông";
        window.scrollTo({
            top: 760,
            left: 0,
        ...
        <div className={style.customstyles}>
            <Container>
                <h1 className={style.h1customtext}>
                    <span className={style.spantextcenter}>Gấu bông</span>
                </h1>
