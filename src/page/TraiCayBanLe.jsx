...
let sortedData = lstdatahoa.filter(item => item.Category === "trai-cay-ban-le");

const TraiCayBanLe = ({ setCartItems }) => {
    useEffect(() => {
        document.title = "Trái Cây Bán Lẻ";
        window.scrollTo({
            top: 760,
            left: 0,
        ...
        <div className={style.customstyles}>
            <Container>
                <h1 className={style.h1customtext}>
                    <span className={style.spantextcenter}>Trái cây bán lẻ</span>
                </h1>
