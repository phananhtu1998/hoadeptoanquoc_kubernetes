...
let sortedData = lstdatahoa.filter(item => item.Category === "hoa-chia-buon");

const HoaChiaBuon = ({ setCartItems }) => {
    useEffect(() => {
        document.title = "Hoa Chia Buồn";
        window.scrollTo({
            top: 760,
            left: 0,
        ...
        <div className={style.customstyles}>
            <Container>
                <h1 className={style.h1customtext}>
                    <span className={style.spantextcenter}>Hoa chia buồn</span>
                </h1>
