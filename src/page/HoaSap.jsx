...
let sortedData = lstdatahoa.filter(item => item.Category === "hoa-sap");

const HoaSap = ({ setCartItems }) => {
    useEffect(() => {
        document.title = "Hoa Sáp";
        window.scrollTo({
            top: 760,
            left: 0,
        ...
        <div className={style.customstyles}>
            <Container>
                <h1 className={style.h1customtext}>
                    <span className={style.spantextcenter}>Hoa sáp</span>
                </h1>
