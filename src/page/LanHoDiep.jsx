...
let sortedData = lstdatahoa.filter(item => item.Category === "lan-ho-diep");

const LanHoDiep = ({ setCartItems }) => {
    useEffect(() => {
        document.title = "Lan Hồ Điệp";
        window.scrollTo({
            top: 760,
            left: 0,
        ...
        <div className={style.customstyles}>
            <Container>
                <h1 className={style.h1customtext}>
                    <span className={style.spantextcenter}>Lan hồ điệp</span>
                </h1>
