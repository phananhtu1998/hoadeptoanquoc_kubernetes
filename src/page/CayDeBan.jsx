...
let sortedData = lstdatahoa.filter(item => item.Category === "cay-de-ban");

const CayDeBan = ({ setCartItems }) => {
    useEffect(() => {
        document.title = "Cây Để Bàn";
        window.scrollTo({
            top: 760,
            left: 0,
        ...
        <div className={style.customstyles}>
            <Container>
                <h1 className={style.h1customtext}>
                    <span className={style.spantextcenter}>Cây để bàn</span>
                </h1>
