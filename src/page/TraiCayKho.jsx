...
let sortedData = lstdatahoa.filter(item => item.Category === "trai-cay-kho");

const TraiCayKho = ({ setCartItems }) => {
    useEffect(() => {
        document.title = "Trái Cây Khô";
        window.scrollTo({
            top: 760,
            left: 0,
        ...
        <div className={style.customstyles}>
            <Container>
                <h1 className={style.h1customtext}>
                    <span className={style.spantextcenter}>Trái cây khô</span>
                </h1>
