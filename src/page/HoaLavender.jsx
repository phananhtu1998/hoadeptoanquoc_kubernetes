...
let sortedData = lstdatahoa.filter(item => item.Category === "hoa-lavender");

const HoaLavender = ({ setCartItems }) => {
    useEffect(() => {
        document.title = "Hoa Lavender";
        window.scrollTo({
            top: 760,
            left: 0,
        ...
        <div className={style.customstyles}>
            <Container>
                <h1 className={style.h1customtext}>
                    <span className={style.spantextcenter}>Hoa Lanvender</span>
                </h1>
